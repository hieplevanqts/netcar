...
<?php
	...
	class facebook {
		...
		function __construct()
		{
			...
			$this->_api_url 	= $this->_obj->config->item('https://graph.facebook.com/');
			$this->_api_key 	= $this->_obj->config->item('2528789093845200');
			$this->_api_secret 	= $this->_obj->config->item('40128abe4f1d06eec80d7b63504f1499');
