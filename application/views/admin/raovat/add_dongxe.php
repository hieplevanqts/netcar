...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="<?= base_url('vnadmin/raovat/list_hangxe')?>">Danh sách hãng xe</a></li>
						...
						<div class="tab-content">
							...
							<div id="home" class="tab-pane fade in active">
								...
								<div class="form-group">
									...
									<label class="col-sm-12 form-text">Nhập tên hãng xe</label>
								...
								<div class="form-group">
									...
									<label class="col-sm-12 form-text">Chọn dòng xe</label>

									<div class="col-sm-4" id="error-alias">
										<select name="id_hangxe" class="form-control">						
											<?php if(isset($raovat_hangxe)):											
												foreach($raovat_hangxe as $value):
												?>
											<option <?php if(@$edit->id_hangxe == $value->id ){echo 'selected';}?> value="<?=$value->id;?>"><?=$value->name;?></option>						
										<?php endforeach;
														endif;
												?>
										</select>
