...
$(document).ready(function(){
  $(".id_hangxe").change(function(){
    ...
    $.post("<?php echo base_url()?>vnadmin/raovat/select_dongxe",{id: id},function(data){
      $(".id_dongxe").html(data);
    });
  });
});
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><a href="<?= base_url('vnadmin/raovat/list_doixe2')?>">Danh sách đời xe</a></li>
    ...
    <section class="content">
        ...
        <div class="row">
            ...
            <form class="validate form-horizontal" role="form" id="form-bk" method="POST" action="<?php echo base_url('vnadmin/raovat/add_doixe2')?>" enctype="multipart/form-data">
                        ...
                        <div class="panel-heading">
                            ...
                            <ul class="nav nav-tabs">
                                ...
                                <li class="pull-right">
                                    ...
                                    <button type="button" <?php if (isset ($edit)) { ?> onclick="editItem()"
                            ...
                            <div class="tab-content">
                                ...
                                <div id="home" class="tab-pane fade in active">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label class="col-sm-12 form-text">Nhập tên đời xe</label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12" id="error-alias">
                                            ...
                                            <input type="text" onchange="createAlias(this)" class="form-control input-sm validate[required]" name="alias" value="<?= @$edit->alias; ?>" id="alias" placeholder="" />
																	...
																	<label class="col-sm-2 form-text">Chọn hãng xe</label>

																	<div class="col-sm-4" id="error-alias">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label class="col-sm-2 form-text">Chọn dòng xe</label>

                                        <div class="col-sm-4" id="error-alias">
                                            <select name="id_dongxe" class="form-control id_dongxe" >
                                                <?php if(isset($raovat_dongxe)){
                                                    foreach($raovat_dongxe as $value){
                                                    ?>
                                                    <option <?php if($edit->id_dongxe == $value->id){echo 'selected value=".'.$value->id.'"'; }?>><?php echo $value->name;?></option>
                                                    <?php }}?>
