...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="<?= base_url('vnadmin/raovat/list_antoan')?>">Danh sánh an toàn</a></li>
...
<section class="content">
    ...
    <div class="box">
        ...
        <div class="box-header">
            ...
            <a href="<?= base_url('vnadmin/raovat/add_antoan')?>" class="btn btn-success btn-sm">
        ...
        <div class="box-body">
			...
			<form name="formbk" method="post" action="<?=base_url('vnadmin/raovat/deletes_antoan')?>">
					...
					<tbody>
						...
						<tr>
							...
							<td class="text-center">
                              <a href="<?= base_url('vnadmin/raovat/edit_antoan/' . $v->id) ?>"
								class="btn btn-xs btn-default" title="Sửa"><i class="fa fa-pencil"></i></a>
							<a href="<?= base_url('vnadmin/raovat/delete_raovat_once_antoan/' . $v->id) ?>"
