...
<section class="content">
    ...
    <div class="box">
        ...
        <div class="box-header">
            ...
            <a href="<?= base_url('vnadmin/raovat/add_doixe2')?>" class="btn btn-success btn-sm">
        ...
        <div class="box-body">
			...
			<form name="formbk" method="post" action="<?=base_url('vnadmin/raovat/deletes_doixe')?>">

                <div class="col-sm-8">
				<table id="example" class="table table-bordered table-striped">
<thead>
	<tr>
		<th  width="5%" class="no-sort">Hãng xe</th>
		<th width="30%" >Dòng xe</th>
		<th width="50%" >Đời xe</th>		
...
<tbody>
	 <?php if (isset($hangxe)) {		
		foreach ($hangxe as $v) {
			...
			<?php 
			if(isset($v->list_dongxe)){
				foreach($v->list_dongxe as $value){ ?>
			...
			<tr>
				...
				<?php
				if(isset($value->doixe))
				{
					$stt=1;
					foreach($value->doixe as $v)
					{
...
?>
	...
	<tr>
		...
		<td class="text-center">
		  <a href="<?= base_url('vnadmin/raovat/edit_doixe/' . $v->id) ?>"
			class="btn btn-xs btn-default" title="Sửa"><i class="fa fa-pencil"></i></a>
		<a href="<?= base_url('vnadmin/raovat/delete_raovat_once_doixe/' . $v->id) ?>"
