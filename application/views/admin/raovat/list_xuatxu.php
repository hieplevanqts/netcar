...
<section class="content">
    ...
    <div class="box">
        ...
        <div class="box-header">
            ...
            <a href="<?= base_url('vnadmin/raovat/add_xuatxu')?>" class="btn btn-success btn-sm">
					...
					<tbody>
						...
						<tr>
							...
							<td class="text-center">
                              <a href="<?= base_url('vnadmin/raovat/edit_xuatxu/' . $v->id) ?>"
								class="btn btn-xs btn-default" title="Sửa"><i class="fa fa-pencil"></i></a>
							<a href="<?= base_url('vnadmin/raovat/delete_raovat_once_xuatxu/' . $v->id) ?>"
