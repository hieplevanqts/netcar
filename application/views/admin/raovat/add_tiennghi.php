...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="<?= base_url('vnadmin/raovat/list_tiennghi')?>">Danh sách tiện nghi</a></li>
