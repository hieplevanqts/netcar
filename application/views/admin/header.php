      ...
      <div class="navbar-custom-menu">
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown messages-menu">
            ...
            <a href="<?=base_url();?>khohang/dashboard" class="dropdown-toggle">
...
<?php if($this->session->userdata('phanquyen')) {
    ...
    <li><a href=""><i class="fa fa-book"></i> <span>Modul rao vặt</span></a>
          <ul>
				<li><a href="<?=base_url('vnadmin/raovat/listraovat');?>">Quản lý tin rao</a></li>
				<li><a href="">Cấu hình đăng tin</a>
					<ul>
							<li><a href="<?=base_url('vnadmin/raovat/list_hangxe');?>">Danh sách hãng xe</a></li>
						  <li><a href="<?=base_url('vnadmin/raovat/list_dongxe');?>">Danh sách dòng xe</a></li>
						  <li><a href="<?=base_url('vnadmin/raovat/list_doixe');?>">Danh sách đời xe</a></li>
						  <li><a href="<?=base_url('vnadmin/raovat/list_xuatxu');?>">Danh sách xuất xứ</a></li>   
						  <li><a href="<?=base_url('vnadmin/raovat/list_tiennghi');?>">Danh sách tiện nghi</a></li>
						  <li><a href="<?=base_url('vnadmin/raovat/list_antoan');?>">Danh sách an toàn</a></li>
					</ul>
    ...
    <!--  -->
          <li><a href=""><i class="fa fa-book"></i> <span>Modul phụ tùng</span></a>
              <ul>
                <li><a href="<?= base_url('vnadmin/phu_tung/products')?>"><i class="fa fa-book"></i> <span>Danh sách phụ tùng xe</span></a></li>
                <li><a href="<?= base_url('vnadmin/phu_tung/ds_dm_phutung')?>"><i class="fa fa-book"></i> <span>Danh sách danh mục</span></a></li>

              </ul>
          </li>
          <li><a href="<?= base_url('vnadmin/product/list_xemoi')?>"><i class="fa fa-book"></i> <span>Modul Xe mới</span></a></li>
