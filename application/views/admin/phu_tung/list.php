...
<section class="content">
    ...
    <div class="box">
        ...
        <div class="box-header">
            ...
            <a href="<?= base_url('vnadmin/phu_tung/add')?>" class="btn btn-success btn-sm">
			...
			<form name="formbk" method="post" action="<?=base_url('vnadmin/phu_tung/deletes')?>">
                ...
                <table id="example" class="table table-bordered table-striped">
					...
					<tbody>
						 ...
						 <?php if (isset($all_phutung)) {

                            $stt=1;

                            foreach ($all_phutung as $v) {
						...
						<tr>
							...
							<td><img src="<?=base_url('upload/img/products/'.$v->pro_dir.'/'.@$v->image)?>" style="width:50px;height:50px;"></td>
							<td class="todo-list">
                                <?= @$v->ten_phu_tung ?>
							</td>
							<td><?=@$v->dm->name;?></td>
