...
<?php } ?><?php if(@$config_home->hotline3==1){ ?>
						...
						<div class="form-group">
							...
							<div class="col-sm-12">
								<input name="zalo" type="text" class="form-control input-sm"
									value="<?=@$row->zalo;?>" placeholder="">
							</div>
						</div>
						<div class="form-group">
							<label  class="col-sm-12">Link messenger</label>
							<div class="col-sm-12">
								<input name="link_mess" type="text" class="form-control input-sm"
									value="<?=@$row->link_mess;?>" placeholder="">
							</div>
						</div>
						<?php if(@$config_home->site_promo==1){ ?>
						<div class="form-group">
