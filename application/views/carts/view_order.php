                                        ...
                                        <div class="123">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-4 hidden-xs">
                                                    ...
                                                    <input type="number"  class="form-control input-sm " name="phone_other" value="" placeholder="Số khác - tùy chọn">
                                                    ...
                                                    <div class="info-payment-center">
                                                        ...
                                                        <ul>
                                                            ...
                                                            <li class="info-payment-item">
                                                                ...
                                                                <p>Chúng tôi sẽ cung cấp số tài khoản khi nhân viên gọi điện tới bạn xác nhận đơn hàng
                                            ...
                                            <ul class="qts_order">
                                                ...
                                                <li class="cart-product-name ">
                                                                            ...
                                                                            <span class="col cart-product-images">
                                                                                ...
                                                                                <img src="<?=base_url('upload/img/products/'.$item['pro_dir'].'/'.$item['image']);?>">
                                                                            ...
                                                                            <span class="cart-product-info">
                                                                                ...
                                                                                <p class="cart-product-title">
                                                                                    ...
                                                                                    <a href="<?=site_url('san-pham/'.$item['alias'])?>"><?=@$item['name'];?></a></p>
                                                                            </span>
                                                                            <span class="cart-product-info">
                                                                                <p class="cart-product-title"> <span style="float:left;">màu sắc:</span> <span style="    width: 10px;
    height: 10px; margin-top: 5px;float:left;background:<?=@$item['color'];?>"></span></p>
                            </span> 
                            <span class="cart-product-info">
                                                                                <p class="cart-product-title"> kích thước: <?=@$item['size'];?></p>
                            </span>
