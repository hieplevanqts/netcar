    ...
    <div class="panel-body giohangfix">
        ...
        <div class="col checkout-cart-list ">
            ...
            <ul class="checkout-cart-title">
                ...
                <li class="col cart-product-color"style="width: 7% !important;">Màu sắc</li>
                <li class="col cart-product-size" style="width: 7% !important;">Kích thước</li>
				...
				<?php foreach($items as $item) : ?>
					...
					<li class="cart-product-item" data-record-id="<?=$item['rowid']?>">
						...
						<ul class="qts_order">
                            ...
                            <li class="cart-product-size" style="width: 7% !important;">
                                       <span style="    width: 10px;
    height: 10px;float:left;background:<?=@$item['color'];?>"></span>
                                    </li>
                                     <li class="cart-product-size" style="width: 7% !important;">
