         ...
         <div class="container">
            <div class="row_pc">
               <div class="breadcrum">
                  ...
                  <a href="<?php if(isset($hang_xe->alias)){echo base_url('danh-muc-xe-cu').$hang_xe->alias;}?>.html"><?php if(isset($hang_xe->name)){echo $hang_xe->alias;}?></a>
                  <a href="">Chi tiết</a>
               </div>
            </div>
         </div>
                                                            ...
                                                            <div style="padding-right:30px;" class="col-md-6 col-sm-6 col-xs-12 col-480-12">
                                                                  <table class="table table-striped">
                                                                      ...
                                                                      <tbody>
                                                                        ...
                                                                        <tr>
                                                                          <td><?=$value->content;?></td>  
                                                                          <td><?php if(in_array($value->id, $tn)){echo '<i style="color:green;"class="fa fa-check" aria-hidden="true"></i>';}else{echo '<i style="color:red;" class="fa fa-times" aria-hidden="true"></i>';}?></td>                                                                                                                                                    
                                                                        </tr>
                                                                          <?php  }}?>
                                                                      </tbody>
                                                                    </table>
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12 col- 480-12">
                        <div class="Contact_seller">
                          ...
                          <p class="phone"><span><i class="fa fa-phone" aria-hidden="true"></i> <?=$item->phone_nguoi_ban;?></span></p>
                            <p class="advertised"><a href=""><i class="fa fa-file-text-o" aria-hidden="true"></i> Tin rao cùng người bán (<?=count($list_cung_nguoi_dang);?> tin)</a></p>
                        </div>
                      </div>
                    </div>
