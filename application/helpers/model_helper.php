...
// ***********************************
function view_module_cate_table2($data,$parent=0,$text=''){
    ...
    foreach ($data as $k=>$v) {
        ...
        if ($v->parent_id == $parent) {
            ...
            view_module_cate_table2($data, $id, $text . '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ');
    ...
    foreach ($data as $k=>$v) {
        ...
        if ($v->parent_id == $parent) {
            ...
            echo "<tr>
                    ...
                    <td class=\"text-center hidden\">$img</td>
...
function show_cate_menu($data,$parent=0,$text='',$edit=null){
    ...
    foreach ($data as $k=>$v) {
        ...
        if ($v->parent_id == $parent) {
            ...
            echo '<option value="'.$v->color.'" '.$selected.'>'.$text.$v->name.'</option>';
...
// hien thi danh muc tro dến ID

function show_cate_menu3($data,$parent=0,$text='',$edit){
    ...
    foreach ($data as $k=>$v) {
        ...
        if ($v->parent_id == $parent) {
            ...
            show_cate_menu3($data, $id, $text . '. &nbsp;&nbsp; ',$edit);
