...
function addCart_now($id){
    ...
    $.ajax({
        ...
        url:base_url() + 'addCart_now?id=' + $id,
        ...
        success:function(res){
            ...
            $('.fixsanpham').css('display','block');



            $("#myModal").modal('<div class="alert alert-success alert-dismissible" role="alert">&nbsp;</div>');
...
function addToCart(){
    ...
    if(color == ''){
        ...
        //     type: "POST",
        //     dataType:"html",
        //     url: base_url() + 'modal/get_option_color',
        //     data:{id:id,qty:qty},
    ...
    $.ajax({
        ...
        success:function(res){
            ...
            if(res.check == false){
                ...
                var t='<div class="alert alert-success alert-dismissible alert-ml" role="alert"style="position: absolute;right: 40px;top:0px;width:250px; padding: 15px 5px; ">Sản phẩm đã được thêm vào danh sách yêu thích !</div>';
